...
export default function ContactEditor({ data, onChange }: { data: any; onChange: (data: any) => void }) {
            ...
            <div className="bg-white dark:bg-gray-800 p-6 rounded-lg shadow">
                ...
                <div className="grid gap-4">
                    <div>
                        ...
                        <input type="text" value={data.info?.email || ""} onChange={(e) => handleInfoChange("email", e.target.value)} className="w-full p-2 border rounded dark:bg-gray-700 dark:border-gray-600 dark:text-white" />
                    </div>
                    <div>
                        <label className="block text-sm font-medium mb-1 dark:text-gray-300">Phone</label>
                        <input type="text" value={data.info?.phone || ""} onChange={(e) => handleInfoChange("phone", e.target.value)} className="w-full p-2 border rounded dark:bg-gray-700 dark:border-gray-600 dark:text-white" />
                    </div>
                    <div>
                        <label className="block text-sm font-medium mb-1 dark:text-gray-300">Address</label>
                        <input type="text" value={data.info?.address || ""} onChange={(e) => handleInfoChange("address", e.target.value)} className="w-full p-2 border rounded dark:bg-gray-700 dark:border-gray-600 dark:text-white" />
                    </div>
                </div>
            </div>
        </div>
